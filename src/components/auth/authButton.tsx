...
export default function AuthButton () {
    ...
    if (status === 'unauthenticated') {
        return (
            <div className="max-h-fit">
                ...
                className="flex gap-3 bg-gray-800 shadow hover:bg-gray-900  transition-colors duration-200  border border-gray-200 dark:border-gray-700 text-white rounded-xl shadow-black px-2 py-2.5 min-w-25 cursor-pointer"
                >
   ...
   return (
       <div className="flex flex-col gap-5 justify-end relative max-h-fit" ref={ref}>
            ...
            className="rounded-full hover:shadow-lg shadow shadow-black transition-all duration-300"
            >
                <Image
