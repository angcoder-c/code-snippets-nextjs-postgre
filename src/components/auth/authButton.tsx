    ...
    if (status === 'unauthenticated') {
        return (
            <div className="max-h-fit">
                ...
                className="flex gap-3 bg-gray-800 shadow hover:bg-gray-900  transition-colors duration-200  border border-gray-700 text-white rounded-xl shadow-black px-2 py-2.5 min-w-25 cursor-pointer"
                >
