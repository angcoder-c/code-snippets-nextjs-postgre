...
export default function Navbar () {
    ...
    return (
        <header className="bg-white dark:bg-gray-800 p-4 sm:px-20 rounded-2xl shadow-lg hover:shadow-xl  transition-shadow duration-300 shadow-black border border-gray-200 dark:border-gray-700">
