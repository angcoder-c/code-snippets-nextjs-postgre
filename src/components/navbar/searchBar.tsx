...
export default function SearchBar() {
  ...
  return (
    <form action={updateQueryParams} className="text-white flex flex-col shadow-[inset_0px_-10px_20px_-10px_black] bg-gray-50 dark:bg-gray-900 rounded-xl">
      {/* search bar */}
      <div className="flex gap-2 px-4 py-2 justify-between items-center rounded-xl shadow shadow-black text-black dark:text-white">
        <input
          type="text"
          placeholder="Search"
          value={body}
